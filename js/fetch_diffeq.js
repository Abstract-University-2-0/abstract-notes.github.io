...
const ghUrlPrefix = "https://raw.githubusercontent.com/zimch/" +
  "abstracts/main/diff_eq/live_notes/";
const repoAddr = 'https://api.github.com/repos/zimch/abstracts' +
  '/contents/diff_eq/live_notes';
...
async function fetchNotes() {
  ...
  for (const file of data) {
    ...
    button.onclick = (e) => {
      ...
      frame.src = `https://docs.google.com/viewer?url=${ghUrlPrefix}${e.target.id.substring(1)}/${e.target.id.substring(1)}.pdf&embedded=true`;
